...
#include "DLL_FileBasic.h"
#include "LIB_FileBasic.h"

HINSTANCE g_FileBasic_hModule = NULL;
...
{
	return FileBasicInitialization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return FileBasicFinalization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return FileBasicUpload(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}

DWORD WINAPI Callback2(
	IN LPBYTE	lpInputBuffer,
	IN DWORD	dwInputBufferSize,
	OUT LPBYTE* lppOutputBuffer,
	OUT LPDWORD lpdwOutputBufferSize
...
{
	return FileBasicDownload(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
