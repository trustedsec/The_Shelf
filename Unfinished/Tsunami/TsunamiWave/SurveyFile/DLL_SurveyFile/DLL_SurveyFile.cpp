...
#include "DLL_SurveyFile.h"
#include "LIB_SurveyFile.h"

HINSTANCE g_SurveyFile_hModule = NULL;
...
{
	return SurveyFileInitialization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return SurveyFileFinalization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return SurveyFileCallbackInterface(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
