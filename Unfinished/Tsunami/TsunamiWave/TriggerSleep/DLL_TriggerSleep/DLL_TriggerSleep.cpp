...
#include "DLL_TriggerSleep.h"
#include "LIB_TriggerSleep.h"

HINSTANCE g_TriggerSleep_hModule = NULL;
	...
	LPVOID lpReserved) // reserved
{
	...
	__try
	{
		__try
		{
			...
			g_TriggerSleep_hModule = hinstDLL;
...
{
	return TriggerSleepInitialization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return TriggerSleepFinalization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return TriggerSleepCallbackInterface(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
