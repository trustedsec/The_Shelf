...
#include "DLL_InternetConnect.h"
#include "LIB_InternetConnect.h"

HINSTANCE g_InternetConnect_hModule = NULL;
	...
	LPVOID lpReserved) // reserved
{
	...
	__try
	{
		__try
		{
			...
			g_InternetConnect_hModule = hinstDLL;
...
{
	return InternetConnectInitialization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return InternetConnectFinalization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return InternetConnectSendRequest(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
