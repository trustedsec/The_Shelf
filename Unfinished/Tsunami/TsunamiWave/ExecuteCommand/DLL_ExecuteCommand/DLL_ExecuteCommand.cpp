...
#include "DLL_ExecuteCommand.h"
#include "LIB_ExecuteCommand.h"

HINSTANCE g_ExecuteCommand_hModule = NULL;
	...
	LPVOID lpReserved) // reserved
{
	...
	__try
	{
		__try
		{
			...
			g_ExecuteCommand_hModule = hinstDLL;
...
{
	return ExecuteCommandInitialization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return ExecuteCommandFinalization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return ExecuteCommandCallbackInterface(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
