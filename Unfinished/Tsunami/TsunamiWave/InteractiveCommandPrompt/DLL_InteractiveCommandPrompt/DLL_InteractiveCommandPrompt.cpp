...
#include "DLL_InteractiveCommandPrompt.h"
#include "LIB_InteractiveCommandPrompt.h"

HINSTANCE g_InteractiveCommandPrompt_hModule = NULL;
	...
	LPVOID lpReserved) // reserved
{
	...
	__try
	{
		__try
		{
			...
			g_InteractiveCommandPrompt_hModule = hinstDLL;
...
{
	return InteractiveCommandPromptInitialization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return InteractiveCommandPromptFinalization(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
...
{
	return InteractiveCommandPromptCallbackInterface(lpInputBuffer, dwInputBufferSize, lppOutputBuffer, lpdwOutputBufferSize);
}
